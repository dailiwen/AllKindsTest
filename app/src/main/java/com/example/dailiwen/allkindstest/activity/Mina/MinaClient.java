...
public class MinaClient {
    ...
    public void sendMessage(SfkInfo sfkInfo) {
        mConnectThread.sendMsg(sfkInfo);
    }
    ...
    private class ConnectThread implements Runnable {
        ...
        public void run() {
            ...
            mConnection.getFilterChain().addLast("codec", new ProtocolCodecFilter(new ProtocolCodeFactory(false)));
        ...
        public void sendMsg(SfkInfo sfkInfo) {
            if (mSession != null && mSession.isConnected()) {
                mSession.write(sfkInfo);
            }
        }
