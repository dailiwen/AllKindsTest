package com.example.dailiwen.allkindstest.util;
...
/**
 * DownloadManager工具类，将下载的细节封装，包括下载过程，通知栏，下载后自动安装
 * @date 2018.01.24
 * @author dailiwen
 */
...
public class DownloadUtils {
    ...
    /**
     * 下载到本地后执行安装，其实就是一个打开文件
     */
    private void installAPK() {
        //在安卓7.0以上会出现问题，打开安装包会报错，不是此软件报错，是系统软件报错，尚未解决
        //获取下载文件的Uri
